...
export const CONCEPT_MAP = [
  ...
  {
    key: 'snake',
    triggers: ['ثعبان', 'الثعبان', 'افعى', 'أفعى', 'الافعى', 'الأفعى', 'حية', 'الحية', 'حيه', 'الحيه', 'snake', 'serpent'],
    expansions: ['ثعبان', 'افعى', 'أفعى', 'snake', 'حية'],
  },
  {
    key: 'car',
  ...
  {
    key: 'drink',
    triggers: ['قهوة', 'قهوه', 'كوفي', 'كوب', 'ماء', 'مياه', 'موية', 'شرب', 'أشرب', 'coffee', 'mug', 'cup', 'water', 'drink'],
...
export const CONVERSATIONAL_STOP_WORDS = new Set([
  ...
  'الصورة', 'صورة', 'صوره', 'الصوره', 'صورتها', 'صورت', 'لقطة',
  'كنت', 'ادور', 'أدور', 'ادورله', 'ادورلها', 'ابحث', 'أبحث',
